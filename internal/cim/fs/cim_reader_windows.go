...
// A CimFsReader is a reader to a CIM file opened for read access.
...
func FetchFileFromCim(cimPath, filePath, destinationPath string) (err error) {
	...
	basicInfo := &winio.FileBasicInfo{
		CreationTime:   fstats.CreationTime.toSyscallFiletime(),
		LastAccessTime: fstats.LastAccessTime.toSyscallFiletime(),
		LastWriteTime:  fstats.LastWriteTime.toSyscallFiletime(),
		ChangeTime:     fstats.ChangeTime.toSyscallFiletime(),
