...
require (
	...
	github.com/Microsoft/hcsshim v0.10.0-rc.0
...
replace (
	...
	//github.com/kevpar/cri => dev.azure.com/msazure/ContainerPlatform/_git/containerd.cri main
	github.com/containerd/cri => ../../../containerd/cri
)
